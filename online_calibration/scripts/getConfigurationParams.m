...
experiments.id_dataset = 10;
experiments.id_sample = 1;
experiments.kitti_cam_id = 2;
experiments.fileout = 'results/20200212/frame';
experiments.is_kitti(1) = true;
experiments.num_samples(1) = 50;
