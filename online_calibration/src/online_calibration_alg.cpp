...
int OnlineCalibrationAlgorithm::getch(void)
{
  int ch;
  struct termios oldt;
  struct termios newt;
...
void OnlineCalibrationAlgorithm::mapKeysToVelocities(int key, struct Twist& twist_change_calib)
{

  twist_change_calib.x = 0.0;
  twist_change_calib.y = 0.0;
  twist_change_calib.z = 0.0;
  twist_change_calib.r = 0.0;
  twist_change_calib.p = 0.0;
  twist_change_calib.w = 0.0;

  twist_change_calib.delta_t = 1 / 10.0;
  ...
  {
    case '1':
      twist_change_calib.x = step_pos;
      break;
    case 'q':
      twist_change_calib.x = -step_pos;
      break;
    case '2':
      twist_change_calib.y = step_pos;
      break;
    case 'w':
      twist_change_calib.y = -step_pos;
      break;
    case '3':
      twist_change_calib.z = step_pos;
      break;
    case 'e':
      twist_change_calib.z = -step_pos;
      break;
    case '4':
      twist_change_calib.r = step_ang;
      break;
    case 'r':
      twist_change_calib.r = -step_ang;
      break;
    case '5':
      twist_change_calib.p = step_ang;
      break;
    case 't':
      twist_change_calib.p = -step_ang;
      break;
    case '6':
      twist_change_calib.w = step_ang;
      break;
    case 'y':
      twist_change_calib.w = -step_ang;
      break;
