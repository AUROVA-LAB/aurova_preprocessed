...
#ifndef _dump_imu_data_for_calibration_with_imutk_alg_node_h_
#define _dump_imu_data_for_calibration_with_imutk_alg_node_h_
 ...
 *
 */
class DumpImuDataForCalibrationWithImutkAlgNode : public algorithm_base::IriBaseAlgorithm<DumpImuDataForCalibrationWithImutkAlgorithm>
{
  private:
    ...
    int number_of_transient_samples_in_current_interval_;

    // [subscriber attributes]
    ros::Subscriber imu_;

    /**
     * \brief Callback to read IMU messages.
     */
  ...
  public:
    ...
    */
    DumpImuDataForCalibrationWithImutkAlgNode(void);
